...
- `rules/browser-automation.md` — driving a live browser through any automation driver or testing an extension: shadow DOM, trusted events, waits, real sessions.
