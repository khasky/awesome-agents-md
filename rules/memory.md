...
- Keep user-level preferences separate from per-project facts and search within the relevant scope first, so one project's facts never steer work in another.
