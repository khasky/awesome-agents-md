...
- `destroy`, `taint`, and state surgery (`state rm`/`mv`) fall under the core Boundaries destructive-command rule: never unprompted, always preceded by a state backup.
