...
<!-- Distilled from the Twelve-Factor App (config, backing services), Prisma and Drizzle docs, use-the-index-luke.com, the expand/contract migration pattern, and GitHub's replication-lag throttling practice (freno); cross-checked against production reference implementations. -->
