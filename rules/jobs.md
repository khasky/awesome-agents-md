...
- Every job sets a hard deadline via the runner's timeout and reports terminal status — a hung job holding its lock is a silent outage of everything downstream of its schedule (`rules/containers.md` for the orchestrator knobs).
